...
//--------------------------------------------------------------------------------------------//
//---------------- SCOPE 1: Dataset, Resource, Property --------------------------------------//
//--------------------------------------------------------------------------------------------//


//-------------- Dataset level configuration of Scope 1 --------------------------------------//
        ...
        dataset: {
            ...
            // GRAPH 0
            // ***IMPORTANT***: The 'generic' config for EACH scope will be used if no specific config is defined for a graph.
            'generic': {    // Default/fallback option
              resourceFocusType: [],
            ...
            // GRAPH #2 (ctd. from server.js)
            //example reactor config
            'http://dbpedia.org/sparql': {
              readOnly: 0,
              allowInlineConfig: 1,
              resourceFocusType: ['http://dbpedia.org/ontology/University'],
              datasetLabel: ['DBpedia Universities2']
            },
            ...
            'http://ld-r.org/configurations': {
                ...
                // Use property 'label' as label for resources.
            ...
            //authentication graph for users
            'http://ld-r.org/users': { //was first referenced in general.js
                readOnly: 0,
...
//-------------- Resource level configuration of Scope 1 ------------------------------------------//
...
//-------------- Property level configuration of Scope 1 ------------------------------------------//

        property: {
            // The 'generic' config for each scope will be used if no specific config is defined for a graph / property.
            'generic': {
            ...
            // a property that further specializes itself on top of the attributes it inherits from 'generic' class.
            'https://github.com/ali1k/ld-reactor/blob/master/vocabulary/index.ttl#cloneOf': {
                readOnlyProperty: 1,
                allowPropertyDelete: 0
            },

            //another property specification...
...
//--------------------------------------------------------------------------------------------//
//------------------ SCOPE 2: dataset_resource and dataset_property  ------------------------//
//------------------------------------------------------------------------------------------//


//-------------- dataset_resource level configuration of Scope 2 -----------------------------//
...
//-------------- dataset_property level configuration of Scope 2 -----------------------------//
        ...
        // The resource_property part of Scope 2
        resource_property: {
